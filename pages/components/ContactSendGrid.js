...
export default function ContactSendGrid() {
			...
			<main>
				...
				<header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-blue-50 dark:bg-blue-900 md:h-96">
					<div className="mx-auto mb-10 md:mt-20">
						<div className="badge bg-[#130F49] inline-block ">
							<p className="font-light text-base px-8 py-2 text-gray-50">
								Lets talk
							</p>
						</div>
					...
					>
						...
						<input
							...
							name="fullname"
							className="bg-transparent border-b py-2 pl-4 focus:outline-none  focus:border-b focus:border-green-500 font-light text-gray-500"
						/>
						{errors?.fullname && (
				...
				<section className="">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 mx-2 md:grid-cols-3 gap-6 max-w-6xl md:mx-auto my-20">
						<div className="card p-8 shadow rounded-md flex flex-row items-center space-x-4 hover:cursor-pointer hover:shadow-lg transition duration-200">
							...
							<p className="text-gray-500 font-light">+234-813-506-2054</p>
						</div>

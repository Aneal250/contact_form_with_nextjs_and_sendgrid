...
async function sendEmail(req, res) {
	try {
		await sendgrid.send({
			to: "anealemekah@gmail.com", // Your email where you'll receive emails
			from: "anaelennaemeka@gmail.com", // your website email address here
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Regards<br>Aneal emeka<br><br>+234 08135062054</p>
              <div class="footer-links" style="display: flex;justify-content: center;align-items: center;">
                ...
                <a href="https://github.com/Aneal250" style="text-decoration: none;margin: 8px;color: #9CA3AF;">GitHub</a>
